...
const Summary = () => {
  ...
  const data = playerRow.length != 0 && percentileScores.length != 0 && Grades.length != 0 ? SummaryTable({ playerRow, percentileScores, Grades }): []
        ...
        {showTable && (
            <>
              ...
              <Grid container spacing={3}>
                {SummaryTable({ playerRow, percentileScores, Grades }).map((data, index) => (
